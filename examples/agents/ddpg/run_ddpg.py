...
r"""
This module trains and evaluates DDPG according to
Lillicrap et al. (2015) "Continuous Control with Deep Reinforcement Learning",
which can be found at https://arxiv.org/pdf/1509.02971.pdf

To run:

```bash
tensorboard --logdir $HOME/tmp/ddpg/Pendulum-v0/ --port 2223

python run_ddpg.py --root_dir=$HOME/tmp/ddpg/Pendulum-v0/
```
"""
