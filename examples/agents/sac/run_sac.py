...
r"""
This module trains and evaluates SAC according to
Haarnoja et al. (2018) "Soft Actor-Critic Algorithms and Applications",
which can be found at https://arxiv.org/pdf/1812.05905.pdf

To run:

```bash
tensorboard --logdir $HOME/tmp/sac/Pendulum-v0/ --port 2223

python run_sac.py --root_dir=$HOME/tmp/sac/Pendulum-v0/
```
"""
